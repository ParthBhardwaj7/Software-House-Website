...
export const metadata: Metadata = {
  title: "Our Team",
  description: "Meet the designers, engineers, and leads behind HILO — the team shipping your next product.",
};
    ...
    <div className="page-marketing page-section-y">
      <div className="page-wide">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
          The people building products, design, and relationships at HILO.
        </p>
